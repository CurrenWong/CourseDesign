...
INSERT INTO `major` VALUES (1,2,'能源与动力工程、新能源科学与工程、车辆工程、工业设计、土木工程','机械类'),(2,1,'电子信息工程、通信工程、光电信息科学与工程、测控技术与仪器、智能科学技术、自动化','电子信息类'),(3,2,'环境工程、制药工程、食品质量与安全','环境科学与工程类'),(4,3,'数学与应用数学、应用物理学、应用化学','数学类'),(5,4,'国际经济与贸易、金融学、税收学、管理科学','经济与贸易类'),(6,2,'广告学、传播学、编辑出版学','新闻传播学类'),(7,1,'科技翻译','英语');
